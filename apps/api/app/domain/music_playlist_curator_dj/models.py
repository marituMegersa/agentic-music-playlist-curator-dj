...
class AgenticMusicPlaylistCuratorDjSession(Base):
    __tablename__ = "music_playlist_curator_dj_sessions"
...
class AgenticMusicPlaylistCuratorDjItem(Base):
    __tablename__ = "music_playlist_curator_dj_items"

    id = Column(String, primary_key=True, index=True)
    session_id = Column(String, ForeignKey("music_playlist_curator_dj_sessions.id"))
